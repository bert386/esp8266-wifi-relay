...
void calcSolar(time_t t, SolarElements &SE)
{
    ...
    SE.SAL = SE.STL - 0.00569 - (0.00478 * sin((125.04 - 1934.136 * SE.JCN) * DEG_TO_RAD));
    // Mean Oblique Ecliptic (degrees)
    SE.MOE = 23 + (26 + (21.448 - SE.JCN * (46.815 + SE.JCN *
                                                         (0.00059 - SE.JCN * 0.001813))) /
                            60) /
                      60;
